...
\begin{center}
\qrcode[hyperlink, height=0.9in]{https://web.microsoftstream.com/video/e7920401-81a2-49eb-a227-13baa5128e27}
\end{center}
...
\begin{center}
\qrcode[hyperlink, height=0.9in]{https://web.microsoftstream.com/video/dd591e2b-ba81-44af-b15e-e3b74084d866}
\end{center}
...
\begin{center}
\qrcode[hyperlink, height=0.9in]{https://web.microsoftstream.com/video/4dd1f584-bcad-4111-83bd-e5dfbb75425e}
\end{center}
...
Dès que vous avez ouvert un nouveau programme dans Scratch, sauvegardez-le au format \texttt{Nom-seance3.sb3} (dans le menu \texttt{Fichier}, choisir \texttt{Sauvegarder sur votre ordinateur}). Pendant que vous travaillez, pensez à sauvegarder régulièrement votre travail.   
