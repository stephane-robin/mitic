...
Il ne reste plus qu’à remplacer dans le code principal les parties de code correspondantes par le bloc  \includegraphics[width=1cm]{./images/scratch03/fonction/Scratch_Fonctions_08}. 
...
Définir la fonction \texttt{triangle} contenu dans le code ci-dessous qui permet d'obtenir la figure suivante :
