...
\uneimageici{./images/tableur03/changerVirgule1_excel_crop}{.35\textwidth}
...
\deuximagesGPici{./images/tableur03/ImportCSV1_Excel_crop}{\textwidth}%
...
\deuximagesGPici{./images/tableur03/ImportCSV3_Excel_crop}{\textwidth}%
...
\uneimageici{./images/tableur03/RefFixeVariable3_Excel_crop}{.95\textwidth}
...
\uneimageici{./images/tableur03/TrierFiltrer1_Excel_crop}{.6\textwidth}
...
\uneimageici{./images/tableur03/condition3_Excel_crop}{\textwidth}
...
\uneimageici{./images/tableur03/FonctionSomme_Excel_crop}{.6\textwidth}
...
\end{itemize}
Une fois la mise en forme terminée, enregistrer le document au format \texttt{.xlsx} en le nommant à partir de votre nom : \texttt{Nom-Prénom-date.ods} puis rendre ce fichier sur \emph{Teams} à l'endroit indiqué par votre enseignant (si nécessaire, se reporter à la fiche méthode \emph{Remettre un devoir sur Teams}).
} % fin énoncé
...
\uneimageici{./images/tableur03/IconeFonction_Excel_crop}{.3\textwidth}
