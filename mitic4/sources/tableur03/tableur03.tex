...
\end{itemize}
\vspace{10pt}
Une fois la mise en forme terminée, enregistrer le document au format \texttt{.xlsx} en le nommant à partir de votre nom : \texttt{Nom-seance1.xlsx} puis rendre ce fichier sur \emph{Teams} à l'endroit indiqué par votre enseignant (si nécessaire, se reporter à la fiche méthode \emph{Remettre un devoir sur Teams}, page \pageref{TeamsRemettreDevoir}).
} % fin énoncé
...
Une fois votre travail terminé, exporter votre graphique au format PNG en le nommant à partir de votre nom : \texttt{Nom-seance2.xlsx} puis rendre ce fichier sur \emph{Teams} à l'endroit indiqué par votre enseignant (si nécessaire, se reporter à la fiche méthode \emph{Remettre un devoir sur Teams}, page \pageref{TeamsRemettreDevoir}).
}% fin énoncé
...
Récupérer sur \emph{Teams} le fichier nommé \texttt{Geographie\_Eau\_Tableau.csv}, l'ouvrir avec \emph{Excel} et l'enregistrer au format .XLSX (\texttt{Nom-date.ods}). Dans ce fichier, au départ, les pays sont classés par ordre alphabétique.
...
\end{itemize}
Une fois la mise en forme terminée, exporter le document au format .XLSX en le nommant à partir de votre nom : \texttt{Nom-date.xlsx} puis rendre ce fichier sur \emph{Teams} à l'endroit indiqué par votre enseignant (si nécessaire, se reporter à la fiche méthode \emph{Remettre un devoir sur Teams}, page \pageref{TeamsRemettreDevoir}).
}% fin énoncé
