...
\section{Pour bien démarrer avec \emph{Gimp}}
...
L'objectif est d'obtenir une image comme par exemple celle montrée ci-dessous (haïku écrit par \emph{Bash\={o} Matsuo}, un des quatre maîtres classiques de la discipline).
\end{minipage}\hfill%
\begin{minipage}[c]{.48\textwidth}
\centering%
