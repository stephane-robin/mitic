...
Apprendre à utiliser le correcteur d'orthographe et de grammaire de \emph{Word} dans l'onglet \texttt{Révision}.
...
Apprendre à utiliser le traducteur de \emph{Word} dans l'onglet \texttt{Révision}.
...
Apprendre à rechercher un mot ou un groupe de mots dans le texte avec l'onglet \texttt{Références}.
...
\begin{itemize}   
\item \textbf{insérer un tableau}, voir section \vref{Texte2InsererTableau} ;
\item \textbf{créer une liste à puces}, voir section \vref{Texte2ListePuce} ;
\item \textbf{ajouter un lien hypertexte}, voir section \vref{Texte2LienHyper} ;
\item \textbf{insérer une note de bas de page}, voir section \vref{Texte2NoteBasPage} ;
\item \textbf{utiliser le correcteur d'orthographe}, voir section \vref{Texte2CorrecteurOrtho} ;
\item \textbf{insérer une image et adapter le texte autour de l'image}, voir section \vref{Texte2InsererImage}.
\end{itemize}  
...
Un tableau vide apparaît sur la page. Pour le remplir, il suffit de cliquer sur une cellule et d'y taper le texte souhaité.
