...
Voici une vidéo pour apprendre à communiquer avec \texttt{Scratch}. Pensez à la regarder avant de commencer l'activité de la séance :

\begin{center}
\qrcode[hyperlink, height=0.9in]{https://web.microsoftstream.com/video/4e7256bd-e19a-4ffb-84a4-6275e9fd18ce}
\end{center}
...
\uneimageici{./images/scratch02/french.png}{.4\textwidth}
...
Dès que vous avez ouvert un nouveau programme dans \emph{Scratch}, sauvegardez-le au format \texttt{Nom-seance1.sb3} : dans le menu \texttt{Fichier}, choisir \texttt{Sauvegarder sur votre ordinateur}. Pendant que vous travaillez, pensez à sauvegarder régulièrement votre travail.   
...
\boiteEnonceLarge{Le but de cette séance est de dessiner une spirale, comme montré sur la figure ci-dessous. Il faudra ensuite dessiner une fleur en réutilisant le code conçu pour dessiner la spirale. 
%
...
%
\vspace{10pt}
Une fois le programme terminé, vous enregistrerez votre fichier au format SB3 (le fichier sera nommé à partir de votre nom : \texttt{Nom-seance1.sb3)}, puis vous le rendrez sur \emph{Teams} à l'endroit indiqué par votre enseignant (si nécessaire, se reporter à la fiche méthode \emph{Remettre son devoir}, page \pageref{TeamsRemettreDevoir}).
}

\vspace{12pt}

\emph{Indication} : pour créer la spirale, on pourra par exemple suivre une séquence d'instructions qui effectue les actions suivantes :
...
Voici une vidéo pour apprendre à faire une boucle avec \texttt{Scratch}. Pensez à la regarder avant de commencer l'activité de la séance :

\begin{center}
\qrcode[hyperlink, height=0.9in]{https://web.microsoftstream.com/video/1da28f5c-81a5-47c6-9680-ddd4bc0e5670}
\end{center}
...
Dès que vous avez ouvert un nouveau programme dans \emph{Scratch}, sauvegardez-le au format \texttt{Nom-seance2.sb3} : dans le menu \texttt{Fichier}, choisir \texttt{Sauvegarder sur votre ordinateur}. Pendant que vous travaillez, pensez à sauvegarder régulièrement votre travail.   
...
Une fois le programme terminé, vous enregistrerez votre fichier au format SB3 (le fichier sera nommé à partir de votre nom : \texttt{Nom-seance2.sb3)}, puis vous le rendrez sur \emph{Teams} à l'endroit indiqué par votre enseignant (si nécessaire, se reporter à la fiche méthode \emph{Remettre son devoir}, page \pageref{TeamsRemettreDevoir}).}
...
Voici une vidéo pour apprendre à créer une boucle suivant une condition avec \texttt{Scratch}. Pensez à la regarder avant de commencer l'activité de la séance :

\begin{center}
\qrcode[hyperlink, height=0.9in]{https://web.microsoftstream.com/video/4cbb6739-118d-4519-9044-57ecf93f5b2c}
\end{center}
...
Dès que vous avez ouvert un nouveau programme dans \emph{Scratch}, sauvegardez-le au format \texttt{Nom-seance3.sb3} : dans le menu \texttt{Fichier}, choisir \texttt{Sauvegarder sur votre ordinateur}. Pendant que vous travaillez, pensez à sauvegarder régulièrement votre travail.   
...
Une fois le programme terminé, vous enregistrerez votre fichier au format SB3 (le fichier sera nommé à partir de votre nom : \texttt{Nom-seance3.sb3)}, puis vous le rendrez sur \emph{Teams} à l'endroit indiqué par votre enseignant (si nécessaire, se reporter à la fiche méthode \emph{Remettre son devoir}, page \pageref{TeamsRemettreDevoir}).}
...
\uneimageici{./images/scratch02/variable1.png}{.4\textwidth}
...
\deuximagesici{./images/scratch02/variable2.png}{.7\textwidth}%
...
\begin{itemize}
\item On peut \textbf{créer} une nouvelle variable. %\uneimageici{./images/scratch02/scratchVariable2}{.4\textwidth} 
 Si on choisit \emph{Pour tous les sprites}, la variable est \textbf{globale}, c'est-à-dire qu'elle peut être utilisée partout dans le programme. Si on choisit \emph{Pour ce sprite uniquement}, la variable est \textbf{locale}, c'est-à-dire qu'elle ne peut être utilisée que pour le sprite pour lequel elle a été créée.    
...
\item Enfin, ce nom de variable peut être utilisé à tout moment dans le programme (ici, on demande que le sprite avance d'un nombre de pas égal à la valeur stockée dans la case mémoire \emph{longueur}) : \uneimageici{./images/scratch02/scratchVariableUtiliser}{.22\textwidth}
\end{itemize}
}  

%\vspace{12pt}

\subsubsection{Deuxième étape : le code qui dessine la spirale} 
...
\deuximagesGPici{./images/scratch02/flowchartActivite1}{\textwidth}% 
              {./images/scratch02/codeSpirale1.png}{.9\textwidth}  

\emph{Attention ! Comprenez bien l'algorithme ci-dessus, car lors de la prochaine séance, seul l'algorithme sera donné.} 

\subsubsection{Troisième étape : un code qui efface l'écran}\index{Scratch!Effacer l'écran}\index{Effacer l'écran (Scratch)}
...
\deuximagesGPici{./images/scratch02/flowchartActivite1b}{.75\textwidth}%
              {./images/scratch02/codeEfface.png}{.7\textwidth}
...
\deuximagesici{./images/scratch02/choixArrierePlan.png}{\textwidth}%
...
\deuximagesGPici{./images/scratch02/choixBalle.png}{\textwidth}%
...
\uneimageici{./images/scratch02/wallPong13.png}{.6\textwidth}
