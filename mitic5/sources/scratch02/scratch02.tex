...
\section{Pour bien commencer avec Scratch}




\subsection{Passer Scratch en langue française} 
...
\boiteEnonceLarge{Le but de cette séance est de dessiner une spirale, comme montré sur la figure ci-dessous. Il faudra ensuite dessiner une fleur en réutilisant le script conçu pour dessiner la spirale. Les étapes pour réaliser ce programme sont les suivantes :
%
\begin{itemize}
