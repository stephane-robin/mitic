...
\begin{itemize}   
\item \textbf{passer une piste stéréo en mono}, voir section \vref{Son1stereoMono} ;
\item \textbf{ajouter une piste}, voir section \vref{Son1ajouterPiste} ;
\item \textbf{copier et coller une partie de piste}, voir section \vref{Son1copierColler} ;
\item \textbf{déplacer une partie de piste (glissement temporel)}, voir section \vref{Son1glissement}
\item \textbf{rendre silencieuse une partie de piste}, voir section \vref{Son1silence} ;
\item \textbf{supprimer et raccorder}, voir section \vref{Son1couperRaccorder} ;
\item \textbf{réaliser un fondu en ouverture ou en fermeture}, voir section \vref{Son1fondu}.
\item \textbf{exporter un projet au format MP3 ou WAV}, voir section \vref{Son1export}.
\end{itemize} 
