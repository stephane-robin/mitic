...
Dès que vous avez ouvert un nouveau document dans \emph{Gimp}, sauvegardez-le au format Nom-seance1.jpg : dans le menu \texttt{Fichier}, choisir \texttt{Enregistrer}. Pendant que vous travaillez, pensez à sauvegarder régulièrement votre travail (raccourci clavier \texttt{Cmd + s}).   
...
Dès que vous avez ouvert un nouveau document dans \emph{Gimp}, sauvegardez-le au format Nom-seance2.jpg : dans le menu \texttt{Fichier}, choisir \texttt{Enregistrer}. Pendant que vous travaillez, pensez à sauvegarder régulièrement votre travail (raccourci clavier \texttt{Cmd + s}).   
...
Dès que vous avez ouvert un nouveau document dans \emph{Gimp}, sauvegardez-le au format Nom-seance3.jpg : dans le menu \texttt{Fichier}, choisir \texttt{Enregistrer}. Pendant que vous travaillez, pensez à sauvegarder régulièrement votre travail (raccourci clavier \texttt{Cmd + s}).   
