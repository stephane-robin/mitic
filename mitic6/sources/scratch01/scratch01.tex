...
\subsubsection{Ajouter un script associé au sprite}\label{ScriptLutin}\index{Scratch!Script associé à un objet}\index{Script associé à un objet (Scratch)}
...
Pour construire ce premier script, nous allons suivre les différentes étapes indiquées ci-dessous :
