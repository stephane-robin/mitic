...
\section{Mes premiers pas avec Scratch}\index{Ouvrir!Scratch}\index{Scratch!Ouvrir}
...
\boiteEnonce{Une fois votre programme terminé et enregistré, il faut le remettre sur \emph{Teams} à l'endroit indiqué par votre professeur. Cherchez le dossier de remise de devoir, puis remettez votre devoir. Si nécessaire, se reporter à la fiche méthode \emph{Remettre son devoir}, page \pageref{TeamsRemettreDevoir}.}
...
\boiteEnonce{Attention, ce programme n'est pas si facile. Il va falloir réfléchir un peu avant de construire le code.}
