...
Dès que vous avez ouvert un nouveau document dans \emph{Scratch}, sauvegardez-le au format Nom-seance2.sb3 : dans le menu \texttt{Fichier}, choisir \texttt{Enregistrer}. Pendant que vous travaillez, pensez à sauvegarder régulièrement votre travail (raccourci clavier \texttt{Cmd + s}).   
...
Dès que vous avez ouvert un nouveau document dans \emph{Scratch}, sauvegardez-le au format Nom-seance3.sb3 : dans le menu \texttt{Fichier}, choisir \texttt{Enregistrer}. Pendant que vous travaillez, pensez à sauvegarder régulièrement votre travail (raccourci clavier \texttt{Cmd + s}).   
...
\boiteEnonce{Une fois votre programme terminé, vous devrez l'enregistrer au format .sb3 (le fichier doit être nommé à partir de votre nom : \texttt{Nom-seance3.sb3}) et le rendre sur Teams dans le dossier de remise de devoir, à l'endroit indiqué par votre professeur.}
