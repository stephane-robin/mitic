...
Vous avez entre les mains le premier exemplaire d'une série de trois fascicules qui accompagneront les élèves des classes de 6\up{e}, 5\up{e} et 4\up{e} dans leur découverte et maîtrise de l'outil informatique.
...
%\vspace{18pt}
À la fin de ce fascicule sont proposées des idées d'activités supplémentaires sous forme de projet : ainsi les élèves pourront exploiter les connaissances acquises au cours de l'année. Ces activités pluridisciplinaires permettent aussi de faire comprendre aux élèves que les cours qu'ils suivent ne sont pas des entités cloisonnées, mais, qu'à l'inverse, les compétences qu'ils y développent sont transposables d'une matière à une autre. Dès lors, ils comprendront que ce qu'ils étudient en classe fait partie d’un socle de connaissances transdisciplinaires utiles et nécessaires à leur avenir.\\ \\
%\vspace{18pt}
