...
Au début de l'année, chaque titulaire de 6\up{e} doit emmener les élèves dont il a la charge en salle informatique et leur faire découvrir la plateforme \emph{Flore} (fiche \vref{plateformeFlore}). Au cours de l'année, les professeurs de chaque matière concernée par une fiche sont responsables de sa réalisation avec les élèves.
