...
La première étape est de récupérer sur la page \emph{Teams} du cours l'image à insérer dans le compte rendu. Si nécessaire, se reporter à la fiche méthode \emph{Consulter et télécharger un document}, page \pageref{teamsConsulterTelecharger}.
...
\uneimageici{./images/texte/WordInsertionImage2.png}{.7\textwidth}
