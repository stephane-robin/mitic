...
\section{Qu'est-ce qu'un traitement de texte ?} 
...
\section{Séance Word 1 : \emph{La Belle et la Bête}}\index{Writer!Mise en forme simple d'un texte}\index{Mise en forme d'un texte (Writer)}
...
\section{Séance Word 2 : un texte de Jonathan Swift}\label{ficheTexte2}
...
\boiteEnonce{Essayez par vous-mêmes de trouver comment faire en testant les possibilités du logiciel.\\ \\
...
\section{Séance Word 3 : un compte rendu d'expérience}\label{ficheTexte3}
