...
\prof{Pour cette activité, vous devez préparer l’espace Teams de votre classe pour que les élèves puissent trouver les indices leur permettant d’arriver au bout. Voici la liste de ce qu’il faut faire :

-Dans les fichiers de la classe, dans le support de cours, ajouter un fichier word nommé "indice_mot_mystere.docx" et dont le contenu est le texte suivant : \texttt{Vous avez trouvé la deuxième lettre, c’est le « M » ! La prochaine vous sera révélée dès que vous rejoint une visioconférence…}

-Créer une page dans le bloc-notes de la classe (ou en distribuer une à tous les élèves) dont le titre est "Indice pour le mot mystère" et dont le contenu est le texte suivant : \texttt{La 4ème lettre est un « S ». La prochaine lettre se trouve dans la pièce jointe du devoir que vous devez remettre.}

-Créer un devoir, où les élèves rendront un document avec leur mot. Ce devoir doit avoir une pièce jointe, un document PDF nommé "informations_devoir.pdf" et dont le contenu est le texte suivant : \texttt{Bravo, vous avez trouvé la dernière lettre ! C’est un « A ». Maintenant, vous devez former un mot avec les lettres que vous avez trouvées et le rendre comme un devoir. Attention! Vous ne pouvez utiliser chaque lettre qu'une fois, et ne devez utiliser que celles que vous avez trouvées!}

-Imprimer un document sur lequel on peut clairement lire ceci: \texttt{Avec ce « T », ça fait déjà 3 lettres ! La prochaine se trouve dans une feuille du bloc-notes.} et l'imprimer sur une page que vous allez replier de manière à pouvoir la faire tenir debout. Ouvrez une visioconférence et positionnez votre caméra de manière à ce qu'on puisse lire le texte sur le document imprimé.

-Créer une nouvelle publication (ou annonce) avec comme contenu le texte suivant: \texttt{La première lettre est le « E » et vous trouverez la prochaine dans un fichier du dossier « support de cours ».}
