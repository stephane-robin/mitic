...
\def\ChoixDeVersion{PASprof} % soit {prof} et alors les commentaires profs sont ajoutés, soit autre chose PASprof
...
%
% trois image ici
% 2 paramètres par image, 1 et 3 et 5 :la taille, 2 et 4 et 6: l'échelle
\newcommand{\troisimagesici}[6]{%
\vspace{8pt}
\begin{center}
